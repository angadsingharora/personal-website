        ...
        <FadeIn delay={0.15}>
          <div className="mt-8 flex flex-wrap items-center gap-5">
            <a
              ...
              className="group inline-flex items-center gap-2 text-neutral-500 dark:text-neutral-400 hover:text-accent transition-colors"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="4" width="20" height="16" rx="2" />
                <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
              </svg>
              <span className="text-sm">angadsingharora@gmail.com</span>
            </a>

            <span className="text-neutral-300 dark:text-neutral-800 hidden sm:inline">&middot;</span>
